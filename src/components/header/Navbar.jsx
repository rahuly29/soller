...
//     return (
//         <nav className="navbar position-fixed w-75 navbar-expand-lg bg-transparent">
...
//                         <img src="/assets/icons/headphone.svg" alt="" className='px-3' />
//                         555 818 282
//                     </a>
//                     <Button>
//                         <span className='btn-heading '> Request a Quote </span>
//                         <span className='px-2'><img src="/assets/icons/rightArrow.svg" alt="" /></span>
//                     </Button>
//                 </div>
//             </div>
//         </nav>
